...
3. **Color identity**: fetch the commander's `color_identity` from Scryfall; spot-check any
   card suspected of being outside it (verify via Scryfall, not memory — mana costs miss
   identity from abilities and back faces).
